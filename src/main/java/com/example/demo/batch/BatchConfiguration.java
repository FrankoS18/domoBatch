...
import com.example.demo.batch.processor.PersonaItemProcessor;
...
public class BatchConfiguration {
	...
	public FlatFileItemReader<Persona> reader(){
		return new FlatFileItemReaderBuilder<Persona>()
			   ...
			   .resource(new ClassPathResource("sample-data.csv")) // Se define desde donde obtiene los datos
			   .delimited()
			   .names(new String[] {"primerNombre", "apellido", "telefono"})
	...
	public JdbcBatchItemWriter<Persona> writer(DataSource dataSource){
		return new JdbcBatchItemWriterBuilder<Persona>()
				...
				.sql("INSERT INTO persona (primer_nombre, apellido, telefono) VALUES (:primerNombre, :apellido, :telefono)")
